...
const Auth = (isModel = false) => {
  ...
  const handleGoogleAuth = async () => {
    try {
      //first open consured SCREEN  for Email verification here----
    ...
    >
      ...
      >
        ...
        <motion.button
          ...
          whileHover={{ opacity: 1.05, scale: 1.05 }}
          whileTap={{ opacity: 1, scale: 0.98 }}
          className="w-full flex items-center mt-6 justify-center gap-3 py-3 bg-black text-white rounded-full shadow-md"
        >
          <FcGoogle size={20} />
